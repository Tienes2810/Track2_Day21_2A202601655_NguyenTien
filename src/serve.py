...
# Lab cho phep GCP/AWS/Azure. Repo nay dung AWS S3 (tuong duong GCS_BUCKET).
S3_BUCKET = (
...
if not S3_BUCKET:
    raise RuntimeError("S3_BUCKET (or CLOUD_BUCKET / GCS_BUCKET) is required")
...
def download_model():
    ...
    hoac IAM instance profile de xac thuc.
    """
